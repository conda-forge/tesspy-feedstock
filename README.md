...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/tesspy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15589&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/tesspy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `tesspy` can be installed with:

```
conda install tesspy
```

It is possible to list all of the versions of `tesspy` available on your platform with:
